...
def sort(X_train_scale, y_train):
    ...
    for j in range(1):
        ...
        for i in range(len(find_midpoint)):
            ...
            left_criterion_value = round(_entropy(left, 3), 3)
            right_criterion_value = round(_entropy(right, 3), 3)
            information.append(
    ...
    return return_information[3], return_information[4]
...
def main():
    ...
    print('----------------')
    print(sort(X_train_scale, y_train))
